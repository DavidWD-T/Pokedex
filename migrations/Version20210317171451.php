 ...
 */
final class Version20210317171451 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, pv INT NOT NULL, attaque INT NOT NULL, defense INT NOT NULL, attaque_spe INT NOT NULL, defense_spe INT NOT NULL, vitesse INT NOT NULL, numero INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pokemon_type (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, pokemon_numero INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql("INSERT INTO `type` (`id`, `name`, `color`) VALUES
        (1, 'Acier', 'aaaabb'),
        (2, 'Combat', 'bb5544'),
        (3, 'Dragon', '7766ee'),
        (4, 'Eau', '3399ff'),
        ...
        $this->addSql("INSERT INTO `pokemon` (`id`, `nom`, `pv`, `attaque`, `defense`, `attaque_spe`, `defense_spe`, `vitesse`, `numero`) VALUES
        ...
        $this->addSql("INSERT INTO `pokemon_type` (`id`, `pokemon_numero`, `type_id`) VALUES
        (431, 1, 10),
        (432, 1, 11),
        (433, 2, 10),
        (434, 2, 11),
